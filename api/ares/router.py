...
from api.ares.services.microsoft_entra_id import MicrosoftEntraID, Scope
...
async def login(http_login: http.Login) -> MicrosoftIdentityToken:
    return await MicrosoftEntraID.get_access_token(http_login.application_name, [Scope.USER_READ])
